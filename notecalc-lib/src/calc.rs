...
mod tests {
    ...
    fn test_cancelling_out() {
        ...
        test_with_dec_count(303,"60 km/h*h/h/h * 1", "0. m / s^2");
    ...
    #[test]
    fn test_func_pi() {
        test_with_dec_count(1000, "pi()", "3.");
        test("pi(1)", "Err");
    }

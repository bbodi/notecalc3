...
* @param {number} result_precision
* @param {boolean} fancy_chars_enabled
* @param {boolean} show_line_numbers
* @returns {number}
*/
__exports.create_app = function(client_width, client_height, theme_index, result_precision, fancy_chars_enabled, show_line_numbers) {
    var ret = wasm.create_app(client_width, client_height, theme_index, result_precision, fancy_chars_enabled, show_line_numbers);
    return ret >>> 0;
};
...
* @param {boolean} show
*/
__exports.show_cursor = function(app_ptr, show) {
    wasm.show_cursor(app_ptr, show);
};
...
* @param {boolean} focus
*/
__exports.set_focus = function(app_ptr, focus) {
    wasm.set_focus(app_ptr, focus);
};
...
* @param {number} y
*/
__exports.set_scroll_y = function(app_ptr, y) {
    wasm.set_scroll_y(app_ptr, y);
};
...
* @param {number} prec
*/
__exports.set_result_precision = function(app_ptr, prec) {
    wasm.set_result_precision(app_ptr, prec);
};
...
*/
__exports.set_fancy_chars = function(app_ptr, enable) {
    wasm.set_fancy_chars(app_ptr, enable);
};
...
*/
__exports.get_and_clear_title_changed = function(app_ptr) {
    wasm.get_and_clear_title_changed(8, app_ptr);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
    let v0;
    if (r0 !== 0) {
...
* @param {number} y
*/
__exports.handle_click = function(app_ptr, now, x, y) {
    wasm.handle_click(app_ptr, now, x, y);
};
...
* @returns {number}
*/
__exports.get_clipboard_len = function(app_ptr) {
    var ret = wasm.get_clipboard_len(app_ptr);
    return ret >>> 0;
};
...
* @returns {number}
*/
__exports.get_clipboard_ptr = function(app_ptr) {
    var ret = wasm.get_clipboard_ptr(app_ptr);
    return ret;
};
...
* @param {number} app_ptr
*/
__exports.clear_clipboard = function(app_ptr) {
    wasm.clear_clipboard(app_ptr);
};
...
* @returns {string | undefined}
*/
__exports.get_selected_text_and_clear_app_clipboard = function(app_ptr, cut) {
    wasm.get_selected_text_and_clear_app_clipboard(8, app_ptr, cut);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
    let v0;
    if (r0 !== 0) {
...
* @returns {boolean}
*/
__exports.handle_input = function(app_ptr, now, input, modifiers) {
    var ret = wasm.handle_input(app_ptr, now, input, modifiers);
    return ret !== 0;
};
